...
| `IP`         | IP адрес передаваемый в сервер uvicorn при запуске | (обязательно) |
...
### Запуск и использование
 Продемонстрированный запуск и использование сервиса на основе контейнеризации предполагает
 что обращения осуществляются из внешней системы, но локально, то есть так как это тестилось,
 однако в реальной развернутой системе адреса обращений могу отличаться.